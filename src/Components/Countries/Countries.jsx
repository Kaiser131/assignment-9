...
const Countries = () => {
    ...
    return (
        <div className="relative" >
            ...
            <div style={{ backgroundImage: `url("${map}")`, position: "sticky" }} className="w-screen  z-10 font-sans h-screen bg-no-repeat bg-cover bg-center  bg-fixed  ">
                ...
                <div className="sticky">
                    ...
                    <div className="grid grid-cols-3 md:grid-cols-7 w-5/6 mx-auto pl-14 relative">
                        {
